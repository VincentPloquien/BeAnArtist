...
if ($role != "invité") {
    ...
    $res = $DB->query("INSERT INTO Participation (utilisateur, concours, role) VALUES (${utilisateur}, ${id}, 'jury');");
    if (!$res) {
        exit("Erreur SQL : " . $DB->error);
    }

    $_SESSION["success"] = "Vous faites maintenant du jury du concours !";
}
